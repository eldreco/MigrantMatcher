...
public class RegistarAjudaHandler extends Handler{
    ...
    public RegistarAjudaHandler(CatalogoUtilizadores catUtilizadores, CatalogoAjudas catAjudas, Voluntario v) throws Exception{
        ...
        if(catalogoUtilizadores.identificar(v))
            ...
            throw new Exception("O voluntario " + v.getID() + " nao esta no catalogo");
    }

    public void registarAjuda(){
        System.out.println("Vamos comecar o processo de oferecer ajuda! Muito obrigado!");
    ...
    public <T extends Ajuda> T indicarTipoAjuda(){
        ...
        T result = null;
        while(whileCond){
            System.out.print("Indique o tipo de ajuda que pretende oferecer. As 2 opcoes sao Alojamento e Item: ");
            String ajuda = sc.nextLine();
            if(ajuda.equals("Alojamento")){
                System.out.print("Indique o numero de pessoas que o alojamento pode acolher, de 1 a 10(ex: 2): ");
                int numeroPessoas = pedirInteiro(1, 10);
                System.out.println("Esta e a lista de regioes disponiveis: ");
                for (Regiao r : EnumSet.allOf(Regiao.class)) {
                    System.out.println(r + " ");
                }
                System.out.print("Indique qual e a regiao do alojamento, seguindo o formato usado na lista: ");
                ...
                System.out.print("Indique uma curta descricao do item: ");
    ...
    private void confirmarCodigo(String codigo) {
    	...
    	while(!confirmacao) {
    		System.out.print("Introduza o codigo enviado por SMS para confirmar a ajuda: ");
